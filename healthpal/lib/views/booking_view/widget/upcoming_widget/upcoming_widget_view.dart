  ...
  final List<Map<String, dynamic>> upcomingBooking = [
    {
      ...
      'doctorName': 'Dr. Manuel Espinoza',
      'specialty': 'Cardiólogo',
      'clinic': 'Clínica de Cuidado del Corazón, Bilwi',
      'image': LocalImages.icFavoriteDoctor1Icon,
      'icon': Icons.location_on,
    },
    {
      'date': '20 de junio de 2024',
      'doctorName': 'Dra. Teresa Rivera',
      'specialty': 'Dermatóloga',
      'clinic': 'Clínica de Salud de la Piel, Bluefields',
      'image': LocalImages.icFavoriteDoctor2Icon,
      'icon': Icons.location_on,
    },
    {
      'date': '15 de junio de 2024',
      'doctorName': 'Dr. Roberto Mena',
      'specialty': 'Odontólogo',
      'clinic': 'Centro de Salud Kukra Hill, RAAS',
      'image': LocalImages.icFavoriteDoctor3Icon,
      'icon': Icons.location_on,
    },
    {
      'date': '20 de junio de 2024',
      'doctorName': 'Dra. Rosa Zamora',
      'specialty': 'Médica General',
      'clinic': 'Hospital Regional Nuevo Amanecer, Bluefields',
      'image': LocalImages.icFavoriteDoctor4Icon,
      'icon': Icons.location_on,
    },
    {
      'date': '15 de junio de 2024',
      'doctorName': 'Dr. Carlos Obando',
      'specialty': 'Cirujano',
      'clinic': 'Clínica San Carlos, Corn Island',
